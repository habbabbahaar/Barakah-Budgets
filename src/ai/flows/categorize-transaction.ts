...
/**
 * @fileOverview AI-powered transaction category suggestion.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a personal finance expert.  Given the description of a transaction, suggest a category for it.

Description: {{{description}}}

Category:`, // Just output the category.  Nothing else.
});
